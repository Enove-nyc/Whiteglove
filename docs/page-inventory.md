...
| `/booking` | Flights and hotels search | Partially complete | Duffel flight search exists. Hotels are blocked by Duffel Stays availability. Needs UI cleanup, booking completion workflow, and stronger error handling. |
| `/booking/review` | Flight selection/review and payment component | Partially complete | Review page exists. Needs real booking confirmation flow, payment/account handling, validation cleanup, and final Duffel production testing. |
