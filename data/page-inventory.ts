...
export const inventoryItems: InventoryItem[] = [
  ...
  },
  {
    ...
    status: "partial",
    priority: "Medium",
    missing: "Duffel Stays approval for in-site hotels, production booking completion, and smaller mobile form cleanup.",
    nextAction: "Keep flights working, get Stays enabled or keep the partner hotel search, then finish booking flow.",
  },
  {
