...
export const inventoryItems: InventoryItem[] = [
  ...
  },
  {
    ...
    area: "Admin page",
    route: "/admin/duffel/review",
    title: "Admin Duffel flight review and payment",
    status: "partial",
    priority: "Medium",
    missing: "A real Duffel access token, then a live ticket test from the admin only.",
    nextAction: "Use /admin/duffel. Visitors are redirected from /book/review to /book.",
  },
  {
    id: "page-login",
    area: "Public page",
