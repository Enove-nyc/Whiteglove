...
export const bulkCemeteries9: Cemetery[] = [
  ...
  {
    slug: "hebron-ancient-cemetery",
    city: "Hebron (Chevron)",
    yiddishCity: "חברון",
    name: "Chevron — the ancient bais hachaim",
    yiddishName: "חברון — בית החיים העתיק",
    country: "Israel / Judea",
    address:
      "Ancient Jewish cemetery, Hebron — on the slope below the old Jewish quarter. No street address is published here; access and route are arranged locally",
    airportRef: "31.529, 35.098",
    arrivalNotes: [
      "This is NOT Me'aras HaMachpela. The Machpela is the Avos and Imahos; this is the town's own bais hachaim, on the slope below the old Jewish quarter, and it holds the mekubalim who lived and died in Chevron. Both are on this site as separate entries and people conflate them.",
      "Access, route and timing in Hebron depend on the security situation and change without notice. Arrange the visit through the Jewish community of Hebron or a guide who works there, and do not plan the day around a route you used before.",
      "The mekubalim are in their own plot within the cemetery. If you are coming for a particular one, ask on the ground rather than walking the rows.",
    ],
    burials: [
      {
        name: "Rabbi Avraham Azulai",
        yiddishName: "רבי אברהם אזולאי",
        knownAs: "The Chesed L'Avraham",
        seforim: "חסד לאברהם · קרית ארבע",
        note: "Circa 1570–1643. Born in Fez and settled in Chevron, where he was niftar and is buried. Named here because lists of Moroccan kevarim sometimes place him in Marrakech — he is not there.",
      },
      {
        name: "Rabbi Eliyahu de Vidas",
        yiddishName: "רבי אליהו די וידאש",
        knownAs: "The Reishis Chochma",
        seforim: "ראשית חכמה",
        note: "Talmid of the Ramak in Tzfat. Reishis Chochma is one of the seforim of mussar and kabbalah most widely learnt from.",
      },
      {
        name: "Rabbi Shlomo Adani",
        yiddishName: "רבי שלמה עדני",
        knownAs: "The Meleches Shlomo",
        seforim: "מלאכת שלמה",
        note: "His peirush on Mishnayos is printed in the standard Mishnayos.",
      },
      {
        name: "Rabbi Chaim Chizkiyahu Medini",
        yiddishName: "רבי חיים חזקיהו מדיני",
        knownAs: "The Sdei Chemed",
        seforim: "שדי חמד",
        note: "1834–1904. Rov of Chevron at the end of his life. Sdei Chemed is the encyclopaedia of halachic literature that sits in most batei midrash.",
      },
      {
        name: "Rabbi Eliyahu Mani",
        yiddishName: "רבי אליהו מני",
        knownAs: "Rov of Chevron",
        note: "Came from Baghdad and led the Chevron kehilla in the nineteenth century.",
      },
    ],
    sourceUrl: "http://en.hebron.org.il/history/465",
  },
  {
    slug: "bnei-brak-ponevezh",
    city: "Bnei Brak",
    yiddishCity: "בני ברק",
    name: "Bnei Brak — the Ponevezh bais hachaim",
    yiddishName: "בני ברק — בית החיים פוניבז׳",
    country: "Israel",
    address: "Ponevezh cemetery, Rechov Chazon Ish, Bnei Brak, Israel — confirm the gate locally",
    airportRef: "32.083, 34.833",
    arrivalNotes: [
      "Bnei Brak has several charedi batei hachaim and they are NOT one ground. Ponevezh and Zichron Meir sit next to each other on Rechov Chazon Ish; Shomrei Shabbos is a third. The Chazon Ish is in Zichron Meir and the Steipler is in Shomrei Shabbos — neither is here. Ask which cemetery for each kever you are coming for, because walking between them is not the same as walking within one.",
      "This ground was opened in the 1960s by the Ponevezher Rov for his yeshiva, and it is largely the roshei yeshiva and mashgichim of Ponevezh. Reb Shach's kever is in a compound of its own rather than in the rows.",
    ],
    burials: [
      { name: "Rabbi Elazar Menachem Man Shach", yiddishName: "רבי אלעזר מנחם מן שך", knownAs: "Reb Shach — rosh yeshiva of Ponevezh", seforim: "אבי עזרי", note: "His kever stands in its own compound, apart from the rows of the yeshiva's rabbonim." },
      { name: "Rabbi Yechezkel Levenstein", yiddishName: "רבי יחזקאל לוינשטיין", knownAs: "Mashgiach of Mir and Ponevezh", seforim: "אור יחזקאל" },
      { name: "Rabbi Shmuel Rozovsky", yiddishName: "רבי שמואל רוזובסקי", knownAs: "Rosh yeshiva of Ponevezh", seforim: "שיעורי רבי שמואל" },
      { name: "Rabbi Michel Yehuda Lefkowitz", yiddishName: "רבי מיכל יהודה לפקוביץ", knownAs: "Rosh yeshiva of Ponevezh L'Tzeirim" },
      { name: "Rabbi Moshe Shmuel Shapira", yiddishName: "רבי משה שמואל שפירא", knownAs: "Rosh yeshiva of Be'er Yaakov" },
      { name: "Rabbi Gedalia Nadel", yiddishName: "רבי גדליה נדל", knownAs: "Talmid of the Chazon Ish" },
      { name: "Rabbi Gershon Edelstein", yiddishName: "רבי גרשון אדלשטיין", knownAs: "Rosh yeshiva of Ponevezh" },
      { name: "Rabbi Rafael Baruch Toledano", yiddishName: "רבי רפאל ברוך טולידאנו", knownAs: "Rov of Meknes", note: "From Morocco; among the rabbonim buried in this ground." },
    ],
    sourceUrl: "https://www.findagrave.com/cemetery/2667890/ponevezh-cemetery",
  },
  {
    slug: "sanhedria-jerusalem",
    city: "Jerusalem",
    yiddishCity: "ירושלים",
    name: "Yerushalayim — the Sanhedria bais hachaim",
    yiddishName: "ירושלים — בית החיים סנהדריה",
    country: "Israel",
    address: "Sanhedria cemetery, Yerushalayim, Israel — confirm the gate locally",
    airportRef: "31.797, 35.216",
    arrivalNotes: [
      "A separate ground from Har HaMenuchos and from Har HaZeisim, and it is the one people most often go to the wrong one for. Rav Ovadia Yosef is here — not on Har HaMenuchos, where lists of gedolim regularly place him.",
      "It sits beside the Sanhedria tombs, which are a different thing again: rock-cut burial caves from the second Temple period, open as an archaeological site.",
    ],
    burials: [
      {
        name: "Rabbi Ovadia Yosef",
        yiddishName: "רבי עובדיה יוסף",
        knownAs: "Posek of Sephardi Jewry",
        seforim: "יביע אומר · יחוה דעת",
        note: "1920–2013. Rishon LeTzion and the leading Sephardi posek of his generation. His levaya in 2013 was the largest in the history of the country.",
      },
    ],
    sourceUrl: "https://www.timesofisrael.com/liveblog_entry/rabbi-ovadia-yosef-buried-in-sanhedria-cemetery/",
  },
];
