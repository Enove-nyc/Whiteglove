...
export const notableShuls: NotableShul[] = [
  ...
  {
    slug: "bratislava-heydukova",
    name: "The Heydukova Street Synagogue",
    city: "Bratislava",
    country: "Slovakia",
    coordinates: "48.1470, 17.1179",
    address: "Heydukova 11-13, Old Town, Bratislava",
    sourceUrl: "https://en.wikipedia.org/wiki/Heydukova_Street_Synagogue",
    notes: [
      "The only working shul in Bratislava, of 1924, in an unusual Cubist style, with a small Jewish museum upstairs.",
    ],
    href: "https://en.wikipedia.org/wiki/Heydukova_Street_Synagogue",
  },
  {
    slug: "dubrovnik-old-synagogue",
    name: "The Old Synagogue of Dubrovnik",
    city: "Dubrovnik",
    country: "Croatia",
    coordinates: "42.6413, 18.1108",
    address: "Žudioska ul. 5, Old Town, Dubrovnik",
    sourceUrl: "https://en.wikipedia.org/wiki/Old_Synagogue_(Dubrovnik)",
    notes: [
    ...
    href: "https://en.wikipedia.org/wiki/Old_Synagogue_(Dubrovnik)",
  },
  {
    slug: "split-synagogue",
    name: "The Split Synagogue",
    city: "Split",
    country: "Croatia",
    coordinates: "43.5085, 16.4402",
    address: "Židovski prolaz 1, Diocletian's Palace, Split",
    sourceUrl: "https://en.wikipedia.org/wiki/Split_Synagogue",
    notes: [
    ...
    href: "https://en.wikipedia.org/wiki/Split_Synagogue",
  },
  {
    slug: "sarajevo-ashkenazi",
    name: "The Ashkenazi Synagogue of Sarajevo",
    city: "Sarajevo",
    country: "Bosnia and Herzegovina",
    coordinates: "43.8573, 18.4210",
    address: "Hamdije Kreševljakovića 59, Sarajevo",
    sourceUrl: "https://en.wikipedia.org/wiki/Sarajevo_Synagogue",
    notes: [
      "The only working shul in Sarajevo, a Moorish-style building of 1902 on the bank of the Miljacka.",
    ],
    href: "https://en.wikipedia.org/wiki/Sarajevo_Synagogue",
  },
  {
    slug: "lisbon-shaare-tikva",
    name: "The Shaaré Tikvah Synagogue",
    city: "Lisbon",
    country: "Portugal",
    coordinates: "38.7213, -9.1517",
    address: "Rua Alexandre Herculano 59, Lisbon",
    sourceUrl: "https://en.wikipedia.org/wiki/Lisbon_Synagogue",
    notes: [
      "The main shul of Lisbon, of 1904, built by Sephardim from Morocco and Gibraltar and set back within its own courtyard.",
    ],
    href: "https://en.wikipedia.org/wiki/Lisbon_Synagogue",
  },
  {
    slug: "madrid-beth-yaacov",
    name: "The Beth Yaacov Synagogue",
    city: "Madrid",
    country: "Spain",
    coordinates: "40.4320, -3.7014",
    address: "Calle de Balmes 3, Chamberí, Madrid",
    sourceUrl: "https://en.wikipedia.org/wiki/Beth_Yaacov_Synagogue_(Madrid)",
    notes: [
      "The main shul of Madrid, opened in 1968 — the first new synagogue built in Spain since the expulsion of 1492.",
    ],
    href: "https://en.wikipedia.org/wiki/Beth_Yaacov_Synagogue_(Madrid)",
  },
];
