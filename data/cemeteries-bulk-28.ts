...
export const bulkCemeteries28: Cemetery[] = [
  ...
  },
  {
    ...
    arrivalNotes: [
      ...
      "A SURVEYED GROUND EXISTS AND IT MAY NOT BE THIS ONE. ESJF records a Jewish cemetery in Šiauliai at 55.92146, 23.32821, about a kilometre and a half from the town centre. Nothing in that survey says whether it is the destroyed old ground this page describes or a different cemetery in the city, so the coordinate is given here as something to check rather than as this listing's map point.",
    ],
    burials: [],
