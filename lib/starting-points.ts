...
export const STARTING_POINTS: readonly StartingPoint[] = [
  {
    ...
    body: "Three short steps — the kind of holiday, roughly where and when — and we come back with destinations that fit. Nothing is required and “I don’t know yet” is a real answer.",
    cta: "Start a trip",
    cost: "Free",
  },
  {
    ...
    body: "The trip planner: days, stops, driving times between them, where Shabbos falls, and a printable copy for the car. No account needed until you want it on your phone.",
  ...
  },
  {
    ...
    body: "Flights, hotels and cars, with cash or with your own miles and points. The search opens with a trusted partner, who takes the booking and the payment.",
  ...
  },
  {
    ...
    body: "We do the planning: destinations, the kosher and Shabbos side, the route, and the itinerary you travel with. Quoted before any work starts.",
    cta: "See what we do",
    cost: "Paid",
  },
];
