...
async function pushAttractionsStaysAreas(docs: DraftDoc[]) {
  ...
  attractions.forEach((a, index) => {
    docs.push({
      ...
      keywords: ["thing to do", "attraction", a.kind, "sightseeing"],
      body: a.summary,
      city: a.city,
      country: a.country,
      rankWeight: index,
...
function pushEateries(docs: DraftDoc[]) {
  kosherEateries.forEach((e, index) => {
    docs.push({
      ...
      keywords: ["kosher", "kosher food", "restaurant", "bakery", "grocery", "groceries", e.kind, e.diet],
      body: e.summary,
      city: e.city,
      country: e.country,
      rankWeight: index,
...
function pushSitePages(docs: DraftDoc[]) {
  const pages: Array<{
    ...
    },
    {
      ...
      href: "/things-to-do",
      names: ["things to do", "attractions"],
      keywords: ["sightseeing", "attraction"],
    },
    {
      id: "page-kosher",
      kind: "Site page",
    ...
    },
    {
      ...
      kind: "Site page",
      title: "Cars",
      subtitle: "Car hire through booking partners",
      href: "/cars",
      names: ["cars", "car hire", "car rental", "rental car"],
      keywords: ["cars", "driving"],
    },
    {
      id: "page-book",
      kind: "Site page",
