 ...
 *
 * SHORTER THAN IT WAS, AND NOT WEAKER. It used to run "AI-generated answers
 * may be inaccurate or out of date. Confirm important kosher and travel
 * details directly" — accurate, and written like a legal department covering
 * itself. The two things a reader has to take away are that a machine wrote it
 * and that they should check before relying on it, and both survive.
 */
 ...
 *
 * "Not reviewed by White Glove" said what we had not done rather than what the
 * reader should do — an internal worry facing outwards. This says the same
 * thing from the reader's side: it is AI, so check what matters.
 */
