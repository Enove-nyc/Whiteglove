...
export const BUILT_IN_LIMITS: Record<AccountPlan, PlanLimits> = {
  traveler: { trips: 2, printsPerWeek: 1, staffSeats: 0 },
  ...
  // are different: a plan that cannot serve clients at all (mayServeCompanionClients
  // is Business-only) has nobody to add a teammate for.
  pro: { trips: UNLIMITED, printsPerWeek: UNLIMITED, staffSeats: 0 },
  business: { trips: UNLIMITED, printsPerWeek: UNLIMITED, staffSeats: 2 },
};
