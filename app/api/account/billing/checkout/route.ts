...
export async function POST(request: NextRequest) {
  ...
  // A SECOND TRIP PASS IS A REAL PURCHASE, not a duplicate. This refused it: a
  // pass is bought per trip now, so somebody taking a second trip is meant to
  // buy a second one, and "you are already on Trip Pass" would have been the
  // site turning down money for a thing it says it sells one at a time. The
  // check still stands for a subscription, where paying twice buys nothing.
