    ...
    <main className="min-h-screen bg-[var(--cream)]">
      ...
      <section className="border-b border-[var(--gold-light)] px-5 py-20 sm:px-8 sm:py-28">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-3 font-[family-name:var(--font-display)] text-3xl text-stone-500 sm:text-4xl">Travel Insurance</p>
          <p className="mt-7 max-w-3xl text-lg leading-8 text-stone-600">
            This page introduces the future travel insurance referral or guidance page. It is designed to explain the coverage types without pretending to be the insurer.
          </p>
        </div>
      </section>
