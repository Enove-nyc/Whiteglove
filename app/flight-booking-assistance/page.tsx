...
export default function FlightBookingAssistancePage() {
  return (
    <main className="min-h-screen bg-[var(--cream)]">
      ...
      <section className="border-b border-[var(--gold-light)] px-5 py-20 sm:px-8 sm:py-28">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-3 font-[family-name:var(--font-display)] text-3xl text-stone-500 sm:text-4xl">Flight Booking Assistance</p>
          <p className="mt-7 max-w-3xl text-lg leading-8 text-stone-600">
            This page is for travelers who want a person to help gather the flight details and request a booking on their behalf.
          </p>
        </div>
      </section>
