          ...
          <section className="wg-page wg-day" key={day.date}>
            ...
            <div className="wg-titleblock">
              <div>
                ...
                <h2 className="wg-daytitle" dir={day.activities.some((activity) => activity.yiddishName) ? "rtl" : undefined} lang={day.activities.some((activity) => activity.yiddishName) ? "yi" : undefined}>{dayRouteTitle(day)}</h2>
