          ...
          <div className="mt-14">
            ...
            <div className="mt-5 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              {matchingAreas.map((area) => (
                <Link key={`area-${area.slug}`} href={`/hotels#${area.slug}`} className="flex min-w-0 flex-col border border-[var(--gold-light)] bg-[#fcfaf6] p-5 transition hover:border-[var(--gold)] hover:shadow-md sm:p-7">
