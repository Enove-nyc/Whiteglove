...
const services = [
  { href: "/planning", title: "Planning", text: "Personalized trip planning and route guidance." },
  { href: "/honeymoon", title: "Honeymoon", text: "A premium honeymoon planning landing page." },
  { href: "/phone-rentals", title: "Phone Rentals", text: "SIM, eSIM, and hotspot support for travel." },
  { href: "/travel-insurance", title: "Travel Insurance", text: "Explain coverage and referral options clearly." },
  { href: "/flight-booking-assistance", title: "Flight Booking Assistance", text: "Collect details for a human-assisted flight booking request." },
];
