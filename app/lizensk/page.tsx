...
const verifiedDetails = [
  ...
  },
  {
    ...
    href: "mailto:hello@whitegloveitineraries.com?subject=Lizhensk%20Hachnasas%20Orchim%20Building%20A",
  },
  {
    label: "Medical help",
  ...
  return (
    <main className="min-h-screen bg-[var(--cream)]">
      ...
      <section className="border-b border-[var(--gold-light)] px-5 py-20 sm:px-8 sm:py-28">
        <div className="mx-auto max-w-7xl"><p className="text-xs font-bold uppercase tracking-[0.26em] text-[var(--gold)]">Featured destination · Poland</p><h1 className="mt-5 max-w-4xl font-[family-name:var(--font-display)] text-5xl leading-tight text-[var(--navy)] sm:text-6xl">Lizhensk<span className="mt-2 block text-3xl text-stone-500 sm:text-4xl">ליזענסק</span></h1><p className="mt-5 font-[family-name:var(--font-display)] text-3xl text-[var(--navy)]">Journey to the Noam Elimelech</p><p className="mt-7 max-w-2xl text-lg leading-8 text-stone-600">A practical, respectful guide to Lizhensk—designed around your tefillos and every essential detail of the visit.</p>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
        <div className="grid gap-10 lg:grid-cols-[.85fr_1.15fr] lg:items-start">
          <div><p className="text-xs font-bold uppercase tracking-[0.24em] text-[var(--gold)]">About the tzaddik</p><h2 className="mt-4 font-[family-name:var(--font-display)] text-4xl leading-tight text-[var(--navy)] sm:text-5xl">Rabbi Elimelech Weisblum of Lizhensk<span className="mt-2 block text-2xl text-stone-500">רבי אלימלך מליזענסק</span></h2><a href="https://www.google.com/maps/search/?api=1&query=G%C3%B3rna%2016%2C%2037-300%20Le%C5%BCajsk%2C%20Poland%2050.25131%2C%2022.42186" target="_blank" rel="noreferrer" className="mt-6 inline-block bg-[var(--navy)] px-5 py-3 text-xs font-bold uppercase tracking-[0.14em] text-white transition hover:bg-[var(--gold)]">Open the kever in maps →</a><SavePlaceButtons place={{ id: "lizensk", name: "Lizhensk", yiddishName: "ליזענסק", address: "Górna 16, 37-300 Leżajsk, Poland", coordinates: "50.25131, 22.42186", href: "/lizensk" }} /><div className="mt-8 border-t border-[var(--gold-light)] pt-5"><p className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--gold)]">Finding the kever</p><ol className="mt-4 space-y-3"><li className="flex gap-3 text-sm leading-6 text-stone-600"><span className="font-semibold text-[var(--gold)]">1.</span><span>Navigate to Górna 16, the Lizhensk Jewish Cemetery.</span></li><li className="flex gap-3 text-sm leading-6 text-stone-600"><span className="font-semibold text-[var(--gold)]">2.</span><span>The kever of Reb Elimelech is within the ohel at the cemetery.</span></li><li className="flex gap-3 text-sm leading-6 text-stone-600"><span className="font-semibold text-[var(--gold)]">3.</span><span>For a yahrzeit visit, expect special access and crowd arrangements; confirm them before you travel.</span></li></ol></div></div>
          <div className="border-l border-[var(--gold)] pl-6"><p className="text-lg leading-8 text-stone-600">Reb Elimelech of Lizhensk was a central early Chassidic leader whose seforim and talmidim shaped generations. His sefer, <em>Noam Elimelech</em>, is a foundational work on the Torah. His yahrzeit is 21 Adar; he was niftar in 5547 (1787).</p><div className="mt-8 grid gap-5 sm:grid-cols-3"><div><p className="text-xs font-bold uppercase tracking-[0.17em] text-[var(--gold)]">Sefer</p><p className="mt-2 font-[family-name:var(--font-display)] text-2xl text-[var(--navy)]">Noam Elimelech</p></div><div><p className="text-xs font-bold uppercase tracking-[0.17em] text-[var(--gold)]">Yahrzeit</p><p className="mt-2 font-[family-name:var(--font-display)] text-2xl text-[var(--navy)]">21 Adar</p></div><div><p className="text-xs font-bold uppercase tracking-[0.17em] text-[var(--gold)]">Niftar</p><p className="mt-2 font-[family-name:var(--font-display)] text-2xl text-[var(--navy)]">5547 / 1787</p></div></div></div>
        </div>
      </section>
      ...
      <section id="contacts" className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
        ...
        <div className="mt-8 border border-[var(--gold-light)] bg-[var(--navy)] p-8 text-white sm:flex sm:items-center sm:justify-between sm:gap-8"><div><p className="text-xs font-bold uppercase tracking-[0.22em] text-[var(--gold-light)]">Help us keep this useful</p><p className="mt-2 text-lg text-slate-100">Have a trusted driver, food contact, or current minyan detail for Lizhensk?</p></div><a href="mailto:hello@whitegloveitineraries.com?subject=Lizhensk%20information" className="mt-5 inline-block shrink-0 border border-[var(--gold-light)] px-6 py-4 text-center text-sm font-bold uppercase tracking-[0.14em] transition hover:bg-[var(--gold)] hover:text-[var(--navy-deep)] sm:mt-0">Share a trusted contact</a></div>
      </section>
      <Footer />
    </main>
  );
