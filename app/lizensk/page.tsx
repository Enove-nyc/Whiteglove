    ...
    <main className="min-h-screen bg-[var(--cream)]">
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
        <div className="grid gap-10 lg:grid-cols-[.85fr_1.15fr] lg:items-start">
          <div><p className="text-xs font-bold uppercase tracking-[0.24em] text-[var(--gold)]">About the tzaddik</p><h2 dir="rtl" className="mt-4 font-[family-name:var(--font-display)] text-4xl leading-tight text-[var(--navy)] sm:text-5xl">רבי אלימלך מליזענסק</h2><p className="mt-3 font-[family-name:var(--font-display)] text-2xl leading-tight text-stone-500 sm:text-3xl">Rabbi Elimelech Weisblum of Lizhensk</p><a href="https://www.google.com/maps/search/?api=1&query=G%C3%B3rna%2016%2C%2037-300%20Le%C5%BCajsk%2C%20Poland%2050.25131%2C%2022.42186" target="_blank" rel="noreferrer" className="mt-6 inline-block bg-[var(--navy)] px-5 py-3 text-xs font-bold uppercase tracking-[0.14em] text-white transition hover:bg-[var(--gold)]">Navigate to the kever →</a><Link href="/cemeteries/lizhensk" className="mt-5 block text-xs font-bold uppercase tracking-[0.14em] text-[var(--navy)] underline decoration-[var(--gold)] decoration-2 underline-offset-4">View this בית החיים →</Link><SavePlaceButtons place={{ id: "lizensk", name: "Lizhensk", yiddishName: "ליזענסק", address: "Górna 16, 37-300 Leżajsk, Poland", coordinates: "50.25131, 22.42186", href: "/lizensk" }} /><div className="mt-8 border-t border-[var(--gold-light)] pt-5"><p className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--gold)]">Finding the kever</p><ol className="mt-4 space-y-3"><li className="flex gap-3 text-sm leading-6 text-stone-600"><span className="font-semibold text-[var(--gold)]">1.</span><span>Navigate to Górna 16, the Lizhensk Jewish Cemetery.</span></li><li className="flex gap-3 text-sm leading-6 text-stone-600"><span className="font-semibold text-[var(--gold)]">2.</span><span>The kever of Reb Elimelech is within the ohel at the cemetery.</span></li><li className="flex gap-3 text-sm leading-6 text-stone-600"><span className="font-semibold text-[var(--gold)]">3.</span><span>For a yahrzeit visit, expect special access and crowd arrangements; confirm them before you travel.</span></li></ol></div></div>
          <div className="border-l border-[var(--gold)] pl-6"><p className="text-lg leading-8 text-stone-600">Reb Elimelech of Lizhensk was a central early Chassidic leader whose seforim and talmidim shaped generations. His sefer, <em>Noam Elimelech</em>, is a foundational work on the Torah. His yahrzeit is 21 Adar; he was niftar in 5547 (1787).</p><div className="mt-8 grid gap-5 sm:grid-cols-3"><div><p className="text-xs font-bold uppercase tracking-[0.17em] text-[var(--gold)]">Sefer</p><p dir="rtl" className="mt-2 font-[family-name:var(--font-display)] text-2xl text-[var(--navy)]">נועם אלימלך</p></div><div><p dir="rtl" className="text-xs font-bold tracking-[0.12em] text-[var(--gold)]">יארצייט</p><p dir="rtl" className="mt-2 font-[family-name:var(--font-display)] text-2xl text-[var(--navy)]">כ״א אדר</p></div><div><p dir="rtl" className="text-xs font-bold tracking-[0.12em] text-[var(--gold)]">שנת פטירה</p><p dir="rtl" className="mt-2 font-[family-name:var(--font-display)] text-2xl text-[var(--navy)]">תקמ״ז / 1787</p></div></div></div>
        </div>
      </section>
