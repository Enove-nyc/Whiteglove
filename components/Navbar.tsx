...
export default function Navbar() {
  ...
  return <nav ref={navRef} className="relative border-b border-[var(--gold-light)] bg-[rgba(247,243,235,0.94)]">
    <div className={`mx-auto h-20 max-w-7xl items-center gap-4 px-5 sm:px-8 ${showSearch ? "grid grid-cols-[auto_minmax(0,1fr)_auto]" : "flex justify-between"}`}>
      <Link href="/" className="flex items-center" aria-label="White Glove Itineraries home"><Image src="/Logo.png.jpeg" alt="White Glove Itineraries" width={500} height={300} className="h-14 w-auto object-contain" priority /></Link>
