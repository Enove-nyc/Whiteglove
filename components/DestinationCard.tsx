...
export default function DestinationCard({
  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        <h3 className="font-[family-name:var(--font-display)] text-3xl text-[var(--navy)]">
          {yiddishName ? (
            <BilingualLabel primary={yiddishName} secondary={name} primaryClassName="text-4xl" secondaryClassName="text-xl" compact />
          ) : (
            <BilingualLabel primary={name} secondary={country} primaryDir="ltr" secondaryDir="ltr" primaryClassName="text-3xl" secondaryClassName="text-sm" compact />
          )}
        </h3>
